...
def mainGame():
    ...
    while True:
        ...
        SCREEN.blit(GAME_SPRITES['base'], (int(basex), int(GROUNDY)))
        ...
        for digit in myDigits:
            SCREEN.blit(GAME_SPRITES['numbers'][digit], (int(Xoffset), int(SCREENHEIGHT*0.12)))
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Roshan')
